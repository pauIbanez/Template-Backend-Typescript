const getUserVerificationEmail = (verificationToken: string) => `
  ...
  <body>
    <div class="container">
      ...
      <section class="welcome">
        ...
        <a href="http://localhost:3000/auth/register/${verificationToken}" class="login-button">LOG IN TO YOUR SUPERUSER</a>
      </section>
      <section class="docs">
